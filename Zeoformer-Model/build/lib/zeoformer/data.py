...
def load_pyg_graphs(
    ...
    # 定义文件路径
    features_total_file = '/public/home/xiaohe/zwan/sxxtest/Matformer/matformer/scripts/jarvis/features_total_all12.pkl'
    ...
    def extract_features_cif(crystal_id, cutoff: float = cutoff, max_neighbors: int= max_neighbors):
        ...
        if os.path.exists(filename):
            ...
            return feature_cs
        absolute_path = '/home/sxx/Matformer/matformer/newtest_zeo/relax/CDO/' + str(crystal_id) + '.cif'
...
def get_train_val_loaders(
    ...
    if (
        ...
        if not dataset_array:
            # d = jdata(dataset)
            d = pd.read_csv('/home/sxx/Matformer/matformer/newtest_zeo/cdo_jl_output.csv')
            # d_test = pd.read_csv('/public/home/xiaohe/zwan/sxxtest/Matformer/matformer/test_data/crystalbonding_2.csv')

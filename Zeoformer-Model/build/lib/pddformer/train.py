...
from pddformer import models
from pddformer.data import get_train_val_loaders
from pddformer.config import TrainingConfig
from pddformer.models.pddformer import PDDFormer
...
def train_dgl(
    ...
    """
    `config` should conform to pddformer.conf.TrainingConfig, and

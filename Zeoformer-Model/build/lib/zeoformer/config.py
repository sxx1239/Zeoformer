...
from zeoformer.models.zeoformer import ZeoformerConfig, BaseSettings
...
class TrainingConfig(BaseSettings):
    ...
    id_tag: Literal["jid", "id", "_oqmd_entry_id", "crystal_id"] = "crystal_id"
    ...
    train_ratio: Optional[float] = 0.008
    val_ratio: Optional[float] = 0.01
    ...
    # model configuration
    model = ZeoformerConfig(name="zeoformer")
    print(model)
    @root_validator()
